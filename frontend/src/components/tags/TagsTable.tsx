...
const DEFAULT_EMPTY_ICON = (
  <svg
    className="h-16 w-16 text-app-text-quiet"
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
    strokeWidth="1.5"
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="space-y-1">
              <div className="inline-flex items-center gap-2 rounded-full border border-app-border bg-app-surface px-2.5 py-1 text-xs font-semibold text-app-text">
                <span
