...
export function DataTable<TData>({
  ...
  bodyClassName = "divide-y divide-app-border",
  rowClassName = "hover:bg-app-surface-muted",
    ...
    <div className="overflow-x-auto">
      <table className={tableClassName}>
        <thead
          className={
            headerClassName ??
            `${stickyHeader ? "sticky top-0 z-10 " : ""}bg-app-surface-muted text-xs font-semibold uppercase tracking-wider text-app-text-quiet`
          }
        >
        ...
        <tbody className={bodyClassName}>
          {isLoading ? (
            ...
            <tr>
              <td
                colSpan={colSpan}
                className="px-6 py-8 text-sm text-app-text-quiet"
              >
                {emptyMessage}
              </td>
            </tr>
