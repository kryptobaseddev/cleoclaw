    ...
    <>
      ...
      >
        {gatewayQuery.isLoading ? (
          <div className="rounded-xl border border-app-border bg-app-surface p-6 text-sm text-app-text-quiet backdrop-blur-glass shadow-card">
            Loading gateway…
          </div>
        ) : gatewayQuery.error ? (
          <div className="rounded-xl border border-app-border bg-app-danger-soft p-6 text-sm text-app-danger">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <div className="rounded-xl border border-app-border bg-app-surface p-6 backdrop-blur-glass shadow-card">
                <div className="flex items-center justify-between">
                  <p className="text-xs font-semibold uppercase tracking-wide text-app-text-quiet">
                    Connection
                  </p>
                ...
                <div className="mt-4 space-y-3 text-sm text-app-text-muted">
                  <div>
                    <p className="text-xs uppercase text-app-text-quiet">
                      Gateway URL
                    </p>
                  ...
                  <div>
                    <p className="text-xs uppercase text-app-text-quiet">Token</p>
                    <p className="mt-1 text-sm font-medium text-app-text">
            ...
            <div className="rounded-xl border border-app-border bg-app-surface p-6 backdrop-blur-glass shadow-card">
              <div className="flex items-center justify-between">
                ...
                {agentsQuery.isLoading ? (
                  <span className="text-xs text-app-text-quiet">Loading…</span>
                ) : (
