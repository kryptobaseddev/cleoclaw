  ...
  return (
    ...
    >
      <form
        ...
        className="rounded-xl border border-app-border bg-app-surface p-6 shadow-sm space-y-6"
      >
        <div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium text-app-text">
                    Board
                    {resolvedIsGatewayMain ? (
                      <span className="ml-2 text-xs font-normal text-app-text-quiet">
                        optional
                      </span>
                    ) : (
                ...
                <SearchableSelect
                  ...
                  triggerClassName="w-full h-11 rounded-xl border border-app-border bg-app-surface px-3 py-2 text-sm font-medium text-app-text shadow-sm focus:border-app-accent focus:ring-2 focus:ring-app-accent/20"
                  contentClassName="rounded-xl border border-app-border bg-app-surface shadow-lg"
          ...
          <div className="mt-6 rounded-xl border border-app-border bg-app-surface-muted p-4">
            <label className="flex items-start gap-3 text-sm text-app-text-muted">
              <input
                type="checkbox"
                className="mt-1 h-4 w-4 rounded border-app-border text-app-accent focus:ring-app-accent/20"
              ...
              <span>
                ...
                <span className="block text-xs text-app-text-quiet">
