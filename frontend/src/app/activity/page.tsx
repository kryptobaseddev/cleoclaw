...
const FeedCard = memo(function FeedCard({
  ...
  return (
    <div
      ...
      className={cn(
        "scroll-mt-28 rounded-xl border bg-app-surface p-4 transition",
        isHighlighted
          ? "border-blue-300 ring-2 ring-app-accent"
          ...
          <div className="min-w-0">
            {item.context_href ? (
              <Link
                ...
                className="block text-sm font-semibold leading-snug text-app-text transition hover:text-app-text hover:underline"
                title={item.title}
                style={{
                  display: "-webkit-box",
                  WebkitLineClamp: 2,
              ...
              <p className="text-sm font-semibold leading-snug text-app-text">
                {item.title}
              </p>
            )}
            <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-app-text-quiet">
              ...
              {item.board_href && item.board_name ? (
                <Link
                  ...
                  className="font-semibold text-app-text-muted hover:text-app-text hover:underline"
                >
                  {item.board_name}
                </Link>
              ) : item.board_name ? (
              ...
              {item.actor_role ? (
                <>
                  <span className="text-app-text-quiet">·</span>
                  <span className="text-app-text-quiet">{item.actor_role}</span>
                </>
              ) : null}
              <span className="text-app-text-quiet">·</span>
            ...
            <main className="flex-1 overflow-y-auto bg-app-surface-muted">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                        <ActivityIcon className="h-5 w-5 text-app-text-muted" />
              ...
              <div className="p-4 md:p-8">
                {hasUnresolvedDeepLink ? (
                  <div className="mb-4 rounded-lg border border-amber-300 bg-app-warning-soft p-3 text-sm text-app-warning">
