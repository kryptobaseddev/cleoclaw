    ...
    >
      ...
      >
        {assignFailedCount && Number.isFinite(assignFailedCount) ? (
          <div className="rounded-xl border border-amber-200 bg-app-warning-soft p-4 text-sm text-app-warning shadow-card">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-2">
            <label className="text-sm font-medium text-app-text">
              Group name <span className="text-app-danger">*</span>
            </label>
            <Input
              value={resolvedName}
        ...
        <div className="space-y-2 border-t border-app-border pt-6">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <div>
              <p className="text-sm font-medium text-app-text">Boards</p>
                      ...
                      <li key={board.id} className="px-4 py-3">
                        <label className="flex cursor-pointer items-start gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-app-text-quiet">
                              <span className="font-mono text-[11px] text-app-text-quiet">
                                {board.id}
                              </span>
                              {isAlreadyGrouped ? (
          ...
          {assignmentsError ? (
            <p className="text-sm text-app-danger">{assignmentsError}</p>
          ) : null}
          {assignmentsResult ? (
